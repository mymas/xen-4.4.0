...
static void *__hvm_map_guest_frame(unsigned long gfn, bool_t writable,bool_t permanent)
{
    void *map;
    p2m_type_t p2mt;
    struct page_info *page;
...
void *hvm_map_guest_frame2(struct domain *d ,unsigned long gfn,bool_t writable,bool_t permanent){

    void *map;
    p2m_type_t p2mt;
    struct page_info *page;

    printk("hvm_map_guest_frame2 |gfn %lx, d->domain_id %d\n,", gfn, d->domain_id);
