...
//add global argument
//extern unsigned long m_val;
//extern struct vcpu *m_v;
//extern unsigned int m_conv;
//extern domid_t target_domid;
//extern uint16_t target_domid;
//extern unsigned long target_gpa;

#ifndef check
extern unsigned long m_l1gfn;
extern uint64_t m_exit_qual;
extern uint32_t m_exit_reason;
extern unsigned int m_page_order;
extern uint8_t m_p2m_acc;
extern unsigned long *m_reg;
extern unsigned long m_gp;
#endif
