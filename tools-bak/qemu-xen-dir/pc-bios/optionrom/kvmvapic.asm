# 1 "/usr/local/xen-4.4.0/tools/qemu-xen/pc-bios/optionrom/kvmvapic.S"
# 1 "<built-in>"
# 1 "<command-line>"
...
.macro read_fw VAR
 ...
 bswap %eax
.endm
# 13 "/usr/local/xen-4.4.0/tools/qemu-xen/pc-bios/optionrom/kvmvapic.S" 2
...
.text 1
 fixup_end = .
.text 0
# 328 "/usr/local/xen-4.4.0/tools/qemu-xen/pc-bios/optionrom/kvmvapic.S"
.text 2
