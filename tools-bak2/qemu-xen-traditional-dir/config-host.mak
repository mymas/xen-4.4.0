...
# Configured with: '/usr/local/xen-4.4.0/tools/../tools/qemu-xen-traditional/configure' '--disable-gfx-check' '--disable-curses' '--disable-slirp' '--prefix=/usr/local'
prefix=/usr/local
bindir=${prefix}/bin
...
VERSION=0.10.2
SRC_PATH=/usr/local/xen-4.4.0/tools/qemu-xen-traditional
VPATH=/usr/local/xen-4.4.0/tools/qemu-xen-traditional
...
XEN_ROOT=/usr/local/xen-4.4.0/tools/..
QEMU_ROOT ?= .
