# 1 "/usr/local/xen-4.4.0/tools/qemu-xen/pc-bios/optionrom/linuxboot.S"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/usr/local/xen-4.4.0/tools/qemu-xen/pc-bios/optionrom/linuxboot.S"
# 23 "/usr/local/xen-4.4.0/tools/qemu-xen/pc-bios/optionrom/linuxboot.S"
...
.macro read_fw VAR
 ...
 bswap %eax
.endm
# 24 "/usr/local/xen-4.4.0/tools/qemu-xen/pc-bios/optionrom/linuxboot.S" 2
