# 1 "/usr/local/xen-4.4.0/tools/qemu-xen/pc-bios/optionrom/multiboot.S"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/usr/local/xen-4.4.0/tools/qemu-xen/pc-bios/optionrom/multiboot.S"
# 21 "/usr/local/xen-4.4.0/tools/qemu-xen/pc-bios/optionrom/multiboot.S"
# 1 "/usr/local/xen-4.4.0/tools/qemu-xen/pc-bios/optionrom/optionrom.h" 1
# 23 "/usr/local/xen-4.4.0/tools/qemu-xen/pc-bios/optionrom/optionrom.h"
# 1 "/usr/local/xen-4.4.0/tools/qemu-xen/pc-bios/optionrom/../../include/hw/nvram/fw_cfg.h" 1
# 24 "/usr/local/xen-4.4.0/tools/qemu-xen/pc-bios/optionrom/optionrom.h" 2
# 38 "/usr/local/xen-4.4.0/tools/qemu-xen/pc-bios/optionrom/optionrom.h"
.macro read_fw VAR
 mov $\VAR, %ax
 mov $0x510, %dx
 outw %ax, (%dx)
 ...
 bswap %eax
.endm
# 22 "/usr/local/xen-4.4.0/tools/qemu-xen/pc-bios/optionrom/multiboot.S" 2
# 31 "/usr/local/xen-4.4.0/tools/qemu-xen/pc-bios/optionrom/multiboot.S"
